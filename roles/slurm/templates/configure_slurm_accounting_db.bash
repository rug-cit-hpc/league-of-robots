...
sacctmgr -i modify qos Name='leftover' set \
    ...
    GrpTRES=cpu=0,mem=0{% if slurm_cluster_gpus_total | int > 0 %},gres/gpu=0{% endif %}{% raw %}{% endraw %}
...
sacctmgr -i modify qos Name='regular-medium' set \
    ...
    MaxTRESPU=cpu={{ slurm_qos_limits['regular-medium']['user']['cores'] }},mem={{ slurm_qos_limits['regular-medium']['user']['mem'] }}{% if slurm_cluster_gpus_total | int > 0 %},gres/gpu={{ slurm_qos_limits['regular-medium']['user']['gpus'] }}{% endif %}{% raw %}{% endraw %}
...
sacctmgr -i modify qos Name='regular-long' set \
    ...
    MaxTRESPU=cpu={{ slurm_qos_limits['regular-long']['user']['cores'] }},mem={{ slurm_qos_limits['regular-long']['user']['mem'] }}{% if slurm_cluster_gpus_total | int > 0 %},gres/gpu={{ slurm_qos_limits['regular-long']['user']['gpus'] }}{% endif %}{% raw %}{% endraw %}
...
sacctmgr -i modify qos Name='priority-short' set \
    ...
    MaxTRESPU=cpu={{ slurm_qos_limits['priority-short']['user']['cores'] }},mem={{ slurm_qos_limits['priority-short']['user']['mem'] }}{% if slurm_cluster_gpus_total | int > 0 %},gres/gpu={{ slurm_qos_limits['priority-short']['user']['gpus'] }}{% endif %}{% raw %}{% endraw %}
...
sacctmgr -i modify qos Name='priority-medium' set \
    ...
    MaxTRESPU=cpu={{ slurm_qos_limits['priority-medium']['user']['cores'] }},mem={{ slurm_qos_limits['priority-medium']['user']['mem'] }}{% if slurm_cluster_gpus_total | int > 0 %},gres/gpu={{ slurm_qos_limits['priority-medium']['user']['gpus'] }}{% endif %}{% raw %}{% endraw %}
...
sacctmgr -i modify qos Name='priority-long' set \
    ...
    MaxTRESPU=cpu={{ slurm_qos_limits['priority-long']['user']['cores'] }},mem={{ slurm_qos_limits['priority-long']['user']['mem'] }}{% if slurm_cluster_gpus_total | int > 0 %},gres/gpu={{ slurm_qos_limits['priority-long']['user']['gpus'] }}{% endif %}{% raw %}{% endraw %}
...
sacctmgr -i modify qos Name='interactive-short' set \
    ...
    MaxTRESPU=cpu={{ slurm_qos_limits['interactive-short']['user']['cores'] }},mem={{ slurm_qos_limits['interactive-short']['user']['mem'] }}{% if slurm_cluster_gpus_total | int > 0 %},gres/gpu={{ slurm_qos_limits['interactive-short']['user']['gpus'] }}{% endif %}{% raw %}{% endraw %}
...
sacctmgr -i modify qos Name='ds-short' set \
    ...
    UsageFactor=1 \
    GrpSubmit=5000  MaxSubmitJobsPU=1000   MaxWall=06:00:00 \
    MaxTRESPU=cpu=4,mem=4096{% if slurm_cluster_gpus_total | int > 0 %},gres/gpu=0{% endif %}{% raw %}{% endraw %}
...
sacctmgr -i modify qos Name='ds-medium' set \
    ...
    UsageFactor=1 \
    GrpSubmit=2500  MaxSubmitJobsPU=500   MaxWall=1-00:00:00 \
    GrpTRES=cpu=2,mem=2048{% if slurm_cluster_gpus_total | int > 0 %},gres/gpu=0{% endif %} \
    MaxTRESPU=cpu=2,mem=2048{% if slurm_cluster_gpus_total | int > 0 %},gres/gpu=0{% endif %}{% raw %}{% endraw %}
...
sacctmgr -i modify qos Name='ds-long' set \
    ...
    UsageFactor=1 \
    GrpSubmit=250   MaxSubmitJobsPU=50   MaxWall=7-00:00:00 \
    GrpTRES=cpu=1,mem=1024{% if slurm_cluster_gpus_total | int > 0 %},gres/gpu=0{% endif %} \
    MaxTRESPU=cpu=1,mem=1024{% if slurm_cluster_gpus_total | int > 0 %},gres/gpu=0{% endif %}{% raw %}{% endraw %}
